// Package validator is adding support for additional validation checks on the data from a client,
// to make sure it meets specific business rules before processing it.
package validator
